...
int main()
{
  ...
  std::string vertex_shader_source =
      parseShader( "C:/1code/fireGl/res/shaders/shader.vert" );
  std::string fragment_shader_source =
      parseShader( "C:/1code/fireGl/res/shaders/shader.frag" );
...
/*
 ...
 glVertexAttribPointer(1, 4, GL_FLOAT, GL_FALSE, sizeof( float ), (void *)( 12 *
